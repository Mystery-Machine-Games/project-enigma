...
@onready var _order: Array[Node] = get_children()
...
func _ready() -> void:
	...
	print("[BUTTON_MODULE][SOLUTION] Interaction: ", Interaction.keys()[_interaction], " Order: ", _order, " Numbers: ", _interaction_nums)
	
	for button in _order:
